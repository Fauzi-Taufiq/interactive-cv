<template>
  <section id="profil" class="container mx-auto px-6 py-20 flex flex col md:flex-row items-center">
    <div class="md:w-1/2 mb-10 md:mb-0">
      ...
      >
        Halo, Saya <span class="text-blue-600">Muhammad Taufiq Al Fauzi</span>
      </h1>
      <p class="text-xl text-gray-600 mb-8 animate-slide-in-left" style="animation-delay: 400ms">
        Mahasiswa Informatika Universitas Amikom Yogyakarta yang antusias dalam pengembangan web,
        desain antarmuka, dan pengelolaan database.
      </p>
      <a
        href="#kontak"
